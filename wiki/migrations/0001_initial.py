# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2019-05-18 17:02
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content', models.TextField()),
                ('pub_date', models.DateTimeField(auto_now_add=True, verbose_name='发表时间')),
                ('article', models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, to='wiki.Article', verbose_name='文章')),
                ('author', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='作者')),
            ],
            options={
                'verbose_name': '评论',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('intro', models.TextField(default='', verbose_name='团队简介')),
            ],
            options={
                'verbose_name': '团队',
